const postModel = require("../models/postCommerceModel");
...
module.exports.createPost = async (req, res) => {
  const { posterId, message, title } = req.body;
  ...
  if (req.file) {
    ...
    await pipeline(
      ...
      fs.createWriteStream(
        `${__dirname}/../../frontend/public/uploads/postsCommerce/${fileName}`
      )
    );
  }
  ...
  const newPost = new postModel({
    posterId,
    message,
    picture: req.file !== null ? "./uploads/postsCommerce/" + fileName : "",
    title,
    likers: [],
    comments: [],
  });
